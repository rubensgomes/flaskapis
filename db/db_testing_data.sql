...
-- sqlite3 c:\personal\flaskapis\flaskapis.db < db_testing_data.sql (Windows Development)
-- sqlite3 /home/wsgi/flaskapis/flaskapis.db < db_testing_data.sql  (Linux Production)
