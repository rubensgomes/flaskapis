...
-- sqlite3 c:\personal\flaskapis\flaskapis.db < sqlite_db_schema.sql (Windows Development)
-- sqlite3 /home/wsgi/flaskapis/flaskapis.db < sqlite_db_schema.sql  (Linux Production)
