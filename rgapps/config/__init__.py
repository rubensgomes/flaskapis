...
Modules:
-------
config: a module used to load / initialize the configuration file.
...
# the application INI configuration instance
ini_config = configparser.SafeConfigParser()

ini_file = os.environ.get("FLASKAPIS_INI_FILE")

# ensure the FLASKAPIS_INI_FILE environment variable is defined
if ini_file is None:
    raise EnvironmentError("FLASKAPIS_INI_FILE not found in environment")

# To avoid cyclic import the following is_blank import must be defined here!
