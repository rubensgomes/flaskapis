...
class ConfigTestCase( unittest.TestCase ):
    ...
    def setUp( self ):
        ...
        ConfigTestCase.sensor_db.add_sensor(SERIAL, 
        ...
        ConfigTestCase.sensor_db.add_measurement( "Celsius", 
                                                  10, 
                                                  utc, 
                                                  SERIAL )
        return
    ...
    def tearDown( self ):
        ...
        ConfigTestCase.sensor_db.del_measurements( SERIAL )
        logging.debug( "deleting sensor from DB" )
        ConfigTestCase.sensor_db.del_sensor( SERIAL )
    ...
    def test_get_sensor( self ):
        ...
        info = ConfigTestCase.sensor_db.get_sensor( SERIAL )
        self.assertIsNotNone( info )
        return

    def test_get_measurements( self ):
        logging.debug( "testing sensor get_measurements" )
        readings = ConfigTestCase.sensor_db.get_measurements( SERIAL,
                                                              "last3Days" )
